    ...
    introOptions : {
      ...
      steps: [     
        ...
        },
        {
          ...
          intro: 'igo-layer-item:nth-child(2) <br> NB: pour la mise en surbrillance index pour nth-child debute a 0 <strong> DANS CE CAS-CI le filtre de couche est présent</strong> et ce dernier prend le 1er index donc pour sélectionner le 1er layer de la liste on doit indiquer ->igo-layer-item:nth-child(2)',
        },
        {
          no: 11,
